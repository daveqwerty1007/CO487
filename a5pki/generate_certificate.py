...
if len(sys.argv) != 6:
    print("Usage: generate_certificate.py ca_identity subject_identity validity_start validity_end usage")
...
signing_key = serialization.load_pem_private_key(string_to_bytes(sk_lines), password=None)
